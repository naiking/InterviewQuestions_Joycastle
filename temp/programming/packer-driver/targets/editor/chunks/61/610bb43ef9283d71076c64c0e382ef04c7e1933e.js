    ...
    execute: function () {
      ...
      _export("Test", Test = (_dec = ccclass('Test'), _dec2 = property({
        ...
        randomExcludeAry(arr, excludeAry) {
          // 过滤出不等于excludeNum的数字
          const filtered = arr.filter(num => num !== excludeAry[0] && num !== excludeAry[1]); // 如果过滤后的数组为空,返回null
        ...
        randomExclude(arr, excludeNum) {
          // 过滤出不等于excludeNum的数字
          const filtered = arr.filter(num => num !== excludeNum); // 如果过滤后的数组为空,返回null
...
//# sourceMappingURL=610bb43ef9283d71076c64c0e382ef04c7e1933e.js.map